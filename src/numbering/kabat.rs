...
const KABAT_HEAVY_REGIONS: &[NumberingRegion] = &[
...
/// Kabat Heavy chain numbering config
pub const KABAT_HEAVY_CONFIG: ChainNumberingConfig = ChainNumberingConfig {
    regions: KABAT_HEAVY_REGIONS,
};
