...
//         let sequence_id = "sequence_1".to_string();
...
//     #[wasm_bindgen(js_name = numberSequenceWithLimit)]
//     pub fn number_sequence_with_limit(
//         &self,
//         sequence: &str,
//         max_chains: usize,
//     ) -> Vec<JsValue> {
//         let sequence_id = "sequence_1".to_string();
//         let results = self.inner.number_sequence_with_limit(sequence, sequence_id, max_chains);
//         results
//             .into_iter()
